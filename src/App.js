    ...
    <div className="text-center py-12 md:py-20 bg-gradient-to-b from-green-50 to-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
        <div className="rounded-lg shadow-md overflow-hidden">
          <img
            src="/images/cabbages.jpg" // Updated path for cabbages
        ...
        <div className="rounded-lg shadow-md overflow-hidden">
          <img
            src="/images/pineapples.jpg" // Updated path for pineapples
        ...
        <div className="rounded-lg shadow-md overflow-hidden">
          <img
            src="/images/roseflowers.jpg" // Updated path for roseflowers with space
            alt="Beautiful roseflowers"
            className="w-full h-48 object-cover"
            onError={(e) => { e.target.onerror = null; e.target.src="https://placehold.co/600x400/CCCCCC/333333?text=Image+Not+Found"; }}
          />
